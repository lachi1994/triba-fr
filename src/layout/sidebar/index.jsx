      ...
      <div className="sidebar-wrapper">
        <div className="logo-wrapper">
          <Link to={`${process.env.PUBLIC_URL}/dashboard/default`}>
            <img className="img-fluid for-light" src={require("../../assets/images/logo/logo1.png")} alt="" width="70%"/>
            <img className="img-fluid for-dark" src={require("../../assets/images/logo/logo1.png")} alt="" />
          </Link>
        ...
        <div className="logo-icon-wrapper">
          <Link to={`${process.env.PUBLIC_URL}/dashboard/default`}><img className="img-fluid" src={require("../../assets/images/logo/logo-icon.png")} alt="" width="40px"/></Link>
        </div>
