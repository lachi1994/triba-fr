            ...
            <div>
              <div>
                <a className="logo" href="index.html">
                  <img className="img-fluid for-light" src={require("../assets/images/logo/logo1.png")} alt="" width="30%"/>
                  <img className="img-fluid for-dark" src={require("../assets/images/logo/logo1.png")} alt="" width="30%"/>
                </a>
              </div>
